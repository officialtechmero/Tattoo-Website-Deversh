        ...
        {similarDesigns.length > 0 && (
          <section className="mt-20">
            <div className="mb-6 flex items-end justify-between">
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-widest text-primary mb-1">Same Style</p>
                <h2 className="font-display text-2xl font-bold tracking-wider">
                  Similar <span className="text-gradient">Designs</span>
                </h2>
                <p className="text-sm text-muted-foreground mt-1">More {design.style} tattoos you might love</p>
              </div>
              <Link
                href="/explore"
          ...
          <section className="mt-20">
            <div className="mb-6 flex items-end justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">Designs across styles that share your taste</p>
              </div>
              <Link
                href="/explore"
                className="text-xs text-muted-foreground underline hover:text-foreground transition-colors"
          ...
          >
            <Heart
              className={`h-3.5 w-3.5 transition-colors duration-200 ${
                isLiked ? "fill-pink-500 text-pink-500 animate-like-pop" : "text-foreground"
              }`}
            />
          </button>
        </div>
